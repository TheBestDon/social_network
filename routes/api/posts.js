...
// @route  GET api/posts/:id @desc   Get post by id @access Public
...
// @route  GET api/posts/ @desc   Get all posts @access Public
...
// @route   DELETE api/posts/:id @desc    Delete post @access  Private
      ...
      Post
        ...
        .then(post => {
          if (post.likes.filter(like => like.user.toString() === req.user.id).length > 0) {
            return res
              .status(400)
              .json({duplicatelike: 'You have already liked this post'})
          }
...
// @route   POST api/posts/comment/:id @desc    Add comment to post @access
// Private
...
// @route   DELETE api/posts/comment/:id/comment_id @desc    Remove comment from
// post @access  Private
